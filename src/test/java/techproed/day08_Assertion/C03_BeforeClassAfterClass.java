...
public class C03_BeforeClassAfterClass {
    ...
    @Test
    public void test02() throws InterruptedException {//yeni bir browser'da test02 methodu çalıştı. Bu method'dan önce before
        // methodu olduğu için önce before çalıştı
        driver.findElement(By.xpath("//*[@class='eicon-close']")).click();
        Thread.sleep(2000);

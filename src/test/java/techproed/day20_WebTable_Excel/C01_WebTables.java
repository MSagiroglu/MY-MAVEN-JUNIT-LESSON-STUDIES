...
public class C01_WebTables extends TestBase {
    ...
    @Test
    public void test01() {
        extentReport("Choreme","Web Table");
        ...
        WebElement ucuncuSatır=driver.findElement(By.xpath("(//table)[1]//tr[3]"));//3.Satırın tamamını verir
        WebElement ucuncuSatırUcuncuSutun=driver.findElement(By.xpath("(//table)[1]//tr[3]//td[3]"));//3.Satırın 3. sütnundaki veriyi verir
        System.out.println("*****************************************");
        System.out.println(ucuncuSatır.getText());
        extentTest.info("Üçüncü satır verileri yazdırıldı.");
        System.out.println(ucuncuSatırUcuncuSutun.getText());

        //    Task 3 : Son satırın verilerini yazdırın
        WebElement sonSatir = driver.findElement(By.xpath("(//table)[1]//tr[last()]"));
        ...
        extentTest.info("Beşinci sütun verileri yazdırıldı.");
        ...
        extentTest.info("3. Satırdaki 1. ve 2. sütun verileri yazdırıldı.");
        ...
        extentTest.info("2. Satır 3. Satır verileri yazdırıldı.");

        System.out.println(printData(3, 2));

        //3. satır 2. sütun bilgisinin Jack olup olmadaığını doğrulayın.

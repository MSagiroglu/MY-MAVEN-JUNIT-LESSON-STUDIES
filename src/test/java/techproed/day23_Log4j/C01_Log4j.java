...
public class C01_Log4j {
    ...
    public void log4j() {
        ...
        kayıt altına almış olacağız. Log4j kullanabilmek için öncelikle Log4j api ve log4j-core dependency lerini mvnrepository.com adresindan (aynı version numaralarına sahip) alıp pom.xml dosyamıza koymalıyız. src>mainZresources
        içine koyduğumuz Log4j.xml dosyasındaki kodlara pdf deki adresten ulaşabilirsiniz.
         */
